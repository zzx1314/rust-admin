...
const urls = {
  ...
  updatePassword: `/api/sysUser/edit`,
  getUserByRoleIdNoPage: `/api/sysUser/getUserByRoleIdNoPage`
};
...
export const checkToken = () => {
  return http.axiosGet(urls.checkToken);
};
...
export const userLogout = (): Promise<UserResult> => {
  return http.axiosGet(urls.logout);
};
