...
use crate::system::sys_role::entity::Column as RoleColumn;
use crate::system::sys_role::entity::Entity as RoleEntity;
use crate::system::sys_role::sys_role_menu::ActiveModel as SysRoleMenuActiveModel;
use crate::system::sys_role::sys_role_menu::Entity as SysRoleMenuEntity;
use crate::system::sys_role::user_role::ActiveModel as UserRoleActiveModel;
        ...
        self.with_conn(move |conn| {
            Box::pin(async move {
                SysRoleMenuEntity::delete_many()
                    .filter(crate::system::sys_role::sys_role_menu::Column::RoleId.eq(role_id))
                    .exec(&*conn)
                    .await?;
