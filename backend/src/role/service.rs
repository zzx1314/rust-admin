...
impl RoleService {
    ...
    pub async fn assign_role(&self, user_id: &str, role_id: &str) -> Result<(), AppError> {
        // Validate that the role exists first
    ...
    pub async fn get_roles_for_user(&self, user_id: &str) -> Result<Vec<Role>, AppError> {
        self.role_repo
    ...
    pub async fn get_users_for_role(&self, role_id: &str) -> Result<Vec<User>, AppError> {
        self.role_repo
