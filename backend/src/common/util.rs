...
/// Format an ISO 8601 datetime string to "yyyy-MM-dd HH:mm:ss" (Beijing time, UTC+8).
/// Input example: "2026-07-21T02:53:47.796Z"
pub fn format_iso_datetime(iso_str: &str) -> String {
    let beijing = FixedOffset::east_opt(8 * 3600).expect("valid offset");
